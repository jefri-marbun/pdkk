        ...
        <div class="card-box-style">
            ...
            <form class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input name="nomorAgenda" type="text" class="form-control" value="<?php echo e($data->nomor_agenda); ?>" id="no_agenda_baru">
                </div>

                <div class="col-md-6">
                    <label for="nomor_nib" class="form-label">Nomor NIB</label>
                    <input name="nomorNIB" type="text" class="form-control" value="<?php echo e($data->nomor_nib); ?>" id="nomor_nib">
            ...
            <form class="row g-3">
                ...
                <div class="col-md-12">
                    <label for="jenisIzin" class="form-label">Jenis Izin<span style="color: red; font-style: italic;">*<span></label>
                        <select id="jenisIzin" class="form-select form-control" disabled>
                            <?php $__currentLoopData = $sp_mig_jenis_izin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($status->id_jenis_izin); ?>"><?php echo e($status->nama_jenis_izin); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <select id="statusIzin" class="form-select form-control" disabled>
                      ...
                      <?php $__currentLoopData = $sp_mig_status_izin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($status->id_status_izin); ?>"><?php echo e($status->nama_status_izin); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                  </div>
                ...
                <div class="col-md-6">
                    <label for="nama_pemilik" class="form-label">Nama Pemilik</label>
                        <input name="namaPemilik" type="text" class="form-control" value="<?php echo e($data->nama_pemilik); ?>" id="nama_pemilik" disabled>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="col-md-4">
                    <label for="bantuan_pemerintah" class="form-label">Bantuan Pemerintah</label>
                        <input name="bantuanPemerintah" type="text" class="form-control" value="<?php echo e($data->bantuan_pemerintah); ?>" id="bantuan_pemerintah" disabled>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="container-fluid">
        <div class="card-box-style">
            ...
            <form class="row g-3">
                ...
                <div class="col-md-4">
                    <label for="no_agenda_baru" class="form-label">Nomor Agenda</label>
                    <input name="nomorAgenda" type="text" class="form-control" value="<?php echo e($data->nomor_agenda); ?>" id="no_agenda_baru" disabled>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="col-md-4">
                    ...
                    <input name="tanggalPermohonan" type="text" class="form-control" value="<?php echo e(date('Y-m-d', strtotime($data->tanggal_permohonan))); ?>" id="tanggal_permohonan" disabled>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="col-md-4">
                    <label for="nomor_izin_usaha" class="form-label">Nomor Izin</label>
                        <input name="nomorIzinUsaha" type="text" class="form-control" value="<?php echo e($data->nomor_izin_usaha); ?>" id="nomor_izin_usaha" disabled>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="col-md-6">
                    <label for="nomor_nib" class="form-label">Nomor NIB</label>
                    <input name="nomorNIB" type="text" class="form-control" value="<?php echo e($data->nomor_nib); ?>" id="nomor_nib" disabled>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <!-- Start Daftar Pemilik (History) -->
                        ...
                        <div class="col-md-4">
                            <label for="alamat_pemilik" class="form-label">Alamat Pemilik</label>
                                <input name="alamatPemilik" type="text" class="form-control" value="<?php echo e($data->alamat_pemilik); ?>" id="alamat_pemilik" disabled>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-md-4">
                            <label for="nama_negara" class="form-label">Nama Negara</label>
                                <input name="namaNegara" type="text" class="form-control" value="<?php echo e($data->nama_negara); ?>" id="nama_negara" disabled>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php $__currentLoopData = $sp_mig_nomor_agenda_baru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-md-3">
                                <label for="rt_pemilik" class="form-label">RT</label>
                                    <input name="rtPemilik" type="text" class="form-control" value="<?php echo e($data->rt_pemilik); ?>" id="rt_pemilik" disabled>
                                </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-md-3">
                            <label for="rw_pemilik" class="form-label">RW</label>
                                <input name="rwPemilik" type="text" class="form-control" value="<?php echo e($data->rw_pemilik); ?>" id="rw_pemilik" disabled>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-md-3">
                            <label for="desa" class="form-label"> </label>
                                <input name="desa" type="text" class="form-control" value="<?php echo e($data->desa); ?>" id="desa">
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-md-4">
                                <label for="provinsi" class="form-label">Provinsi </label>
                                 <input name="provinsi" type="text" class="form-control" value="<?php echo e($data->nama_propinsi); ?>" id="nama_propinsi" >
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php $__currentLoopData = $sp_mig_nomor_agenda_baru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-md-4">
                                ...
                                <input name="kabupaten" type="text" class="form-control" value="<?php echo e($data->nama_kabupaten); ?>" id="nama_kabupaten" >
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php $__currentLoopData = $sp_mig_nomor_agenda_baru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-md-4">
                                ...
                                <input name="kecamatan" type="text" class="form-control" value="<?php echo e($data->kecamatan); ?>" id="kecamatan" >
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php $__currentLoopData = $sp_mig_nomor_agenda_baru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-md-4">
                                ...
                                <input name="npwpPemilik" type="text" class="form-control" value="<?php echo e($data->npwp_pemilik); ?>" id="npwp_pemilik" disabled >
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-md-4">
                            ...
                            <input name="email_pemilik" type="text" class="form-control" value="<?php echo e($data->email_pemilik); ?>" id="email_pemilik" >
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-md-4">
                            ...
                            <input name="nomor_nib" type="text" class="form-control" value="<?php echo e($data->nomor_nib); ?>" id="nomor_nib" disabled >
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-md-4">
                            ...
                            <input name="website_pemilik" type="text" class="form-control" value="<?php echo e($data->website_pemilik); ?>" id="website_pemilik" >
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-md-4">
                            <label for="kodeTelpon1" class="form-label">Telpon 1</label>
                                <input name="kode_telepon1" type="text" class="form-control" value="<?php echo e($data->kode_telepon1); ?>" id="kode_telepon1" >
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-md-4">
                            ...
                            <input name="telepon1_pemilik" type="text" class="form-control" value="<?php echo e($data->telepon1_pemilik); ?>" id="telepon1_pemilik" >
                        </div>
                         <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php $__currentLoopData = $sp_mig_nomor_agenda_baru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <input name="kode_telepon2" type="text" class="form-control" value="<?php echo e($data->kode_telepon2); ?>" id="kode_telepon2" >
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-md-4">
                            ...
                            <input name="telepon2_pemilik" type="text" class="form-control" value="<?php echo e($data->telepon2_pemilik); ?>" id="telepon2_pemilik" >
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-md-4">
                            ...
                            <input name="kode_handphone" type="text" class="form-control" value="<?php echo e($data->kode_handphone); ?>" id="kode_handphone" >
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-md-4">
                            ...
                            <input name="handphone_pemilik" type="text" class="form-control" value="<?php echo e($data->handphone_pemilik); ?>" id="handphone_pemilik" >
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-md-4">
                            ...
                            <input name="kode_faksimili1" type="text" class="form-control" value="<?php echo e($data->kode_faksimili1); ?>" id="kode_faksimili1" >
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="col-md-4">
                                            <label for="faxPemilik" class="form-label"></label>
                                                <input name="faksimili1_pemilik" type="text" class="form-control" value="<?php echo e($data->handphone_pemilik); ?>" id="faksimili1_pemilik" >
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="col-md-4">
                                            <label for="badanHukum" class="form-label"> Badan Hukum </label>
                                                <input name="nama_badan_hukum" type="text" class="form-control" value="<?php echo e($data->nama_badan_hukum); ?>" id="nama_badan_hukum" >
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="col-md-4">
                                            <label for="nomorIdentitas" class="form-label"> KTP </label>
                                                <input name="nomor_identitas" type="text" class="form-control" value="<?php echo e($data->nomor_identitas); ?>" id="nomor_identitas" >
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="col-md-4">
                                            <label for="nomorIdentitas" class="form-label"> Akte Pendirian </label>
                                                <input name="akte_pendirian" type="text" class="form-control" value="<?php echo e($data->akte_pendirian); ?>" id="akte_pendirian" >
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="col-md-4">
                                            <label for="tanggalAktePendirian" class="form-label">Tanggal Akte Pendirian </label>
                                                <input name="tanggalAktePendirian" type="text" class="form-control" value="<?php echo e($data->tanggal_akte_pendirian); ?>" id="tanggal_akte_pendirian" >
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="col-md-4">
                                            <label for="statusPerusahaan" class="form-label">Status Perusahaan </label>
                                                <input name="statusPerusahaan" type="text" class="form-control" value="<?php echo e($data->status_perikanan); ?>" id="status_perikanan" >
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="col-md-4">
                                            <label for="bantuanPemerintah" class="form-label">Bantuan Pemerintah</label>
                                                <input name="bantuanPemerintah" type="text" class="form-control" value="<?php echo e($data->bantuan_pemerintah); ?>" id="bantuan_pemerintah" >
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="col-md-4">
                                            <label for="statusTerpadu" class="form-label">Status Terpadu</label>
                                                <input name="statusTerpadu" type="text" class="form-control" value="<?php echo e($data->status_terpadu); ?>" id="status_terpadu" >
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="col-md-4">
                                            <label for="namaLengkapPJ" class="form-label"> Nama Lenkap </label>
                                                <input name="namaLengkapPJ" type="text" class="form-control" value="<?php echo e($data->penanggung_jawab); ?>" id="penanggung_jawab" >
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="col-md-4">
                                            <label for="jenisIdentitasPJ" class="form-label"> Jenis Identitas </label>
                                                <input name="jenisIdentitasPJ" type="text" class="form-control" value="<?php echo e($data->ktp_penanggung_jawab); ?>" id="ktp_penanggung_jawab" >
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="col-md-4">
                                            <label for="jabatanPJ" class="form-label"> Jabatan </label>
                                                <input name="jabatanPJ" type="text" class="form-control" value="<?php echo e($data->jabatan_penanggung_jawab); ?>" id="jabatan_penanggung_jawab" >
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="col-md-4">
                                            <label for="noIdentitasPJ" class="form-label"> Jabatan </label>
                                                <input name="noIdentitasPJ" type="text" class="form-control" value="<?php echo e($data->nomor_identitas_pengurus); ?>" id="nomor_identitas_pengurus" >
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="others-title mt-5 mb-0">
                                            ...
                                            <div class="col-md-6">
                                                <label for="pemilik_manfaat" class="form-label">Nama Pemilik Manfaat</label>
                                                    <input name="namaPemilikmanfaat" type="text" class="form-control" value="<?php echo e($data->pemilik_manfaat); ?>" id="pemilik_manfaat" disabled>
                                                </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="col-md-6">
                                                <label for="nama_jenis_identitas" class="form-label">Jenis Identitas</label>
                                                    <input name="namaJenisIdentitas" type="text" class="form-control" value="<?php echo e($data->nama_jenis_identitas); ?>" id="nama_jenis_identitas" disabled>
                                                </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="col-md-6">
                                                <label for="jabatan_pemilik_manfaat" class="form-label">Jabatan</label>
                                                    <input name="jabatanPemilikManfaat" type="text" class="form-control" value="<?php echo e($data->jabatan_pemilik_manfaat); ?>" id="jabatan_pemilik_manfaat" disabled>
                                                </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="col-md-6">
                                                <label for="nomor_identitas_pemilik_manfaat" class="form-label">No. Identitas</label>
                                                    <input name="nomorIdentitasPemilikManfaat" type="text" class="form-control" value="<?php echo e($data->nomor_identitas_pemilik_manfaat); ?>" id="nomor_identitas_pemilik_manfaat" disabled>
                                                </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <br>
                                            <script>
                                    ...
                                    <table class="table table-bordered mt-4">
                                        ...
                                        <tbody>
                                            <tr class="d-none">
                                                ...
                                                <td>
                                                    <img src="<?php echo e(URL::asset('resources/assets/images/blog/blog-2.jpg')); ?>" style="width: 200px" class="img-thumbnail" alt="blog-1">
                                                    <img src="<?php echo e(URL::asset('resources/assets/images/blog/blog-2.jpg')); ?>" style="width: 200px" class="img-thumbnail" alt="blog-1">
                                                    <img src="<?php echo e(URL::asset('resources/assets/images/blog/blog-2.jpg')); ?>" style="width: 200px" class="img-thumbnail" alt="blog-1">
                                                    <img src="<?php echo e(URL::asset('resources/assets/images/blog/blog-2.jpg')); ?>" style="width: 200px" class="img-thumbnail" alt="blog-1">
                                                    <img src="<?php echo e(URL::asset('resources/assets/images/blog/blog-2.jpg')); ?>" style="width: 200px" class="img-thumbnail" alt="blog-1">
                                ...
                                <div class="accordion-body">
                                    <form action="/upload-file" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row mt-4 mb-3">
                                            ...
                                            <div class="col-sm-4">
                                                <img src="<?php echo e(asset('resources/assets/images/pemilik/6277.jpg')); ?>" style="width: 400px" class="img-thumbnail" alt="blog-1">
                                                <input class="mt-3" type="file" id="fotoPemilik" name="fotoPemilik">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mt-4 mb-3">
                                            ...
                                            <div class="col-sm-4">
                                                <img id="previewImage" src="<?php echo e(asset('resources/assets/images/pemilik/t6277.jpg')); ?>" style="width: 500px" class="img-thumbnail" alt="blog-1">
                                                ...
                                                <table class="table table-bordered mt-4">
                                                    ...
                                                    <?php $__currentLoopData = $sp_mig_alokasi_lama; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-center"><?php echo e($data->jumlah_persetujuan); ?></td>
                                                            <td><?php echo e($data->operasi_laut_lepas); ?></td>
                                                            <td><?php echo e($data->status_armada); ?></td>
                                                            <td><?php echo e($data->dpi); ?></td>
                                    ...
                                    <div class="others-title mt-3">
                                        <h3>Data Alokasi SIUP Diajukan</h3>
                                                    ...
                                                    <table class="table table-bordered mt-4">
                                                        ...
                                                        <tbody>
                                                            <?php $__currentLoopData = $sp_mig_split_alokasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                <td><?php echo e($loop->iteration); ?></td>
                                                               ...
                                                               <!-- Button to trigger the modal -->
                                                                <td>
                                                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal-<?php echo e($data->idalokasi); ?>">+</button>
                                                                </td>
                                                        
                                            <!-- Modal -->
                                            <div class="modal fade" id="modal-<?php echo e($data->idalokasi); ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modalLabel-<?php echo e($data->idalokasi); ?>" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="modalLabel-<?php echo e($data->idalokasi); ?>">Alokasi SIUP Diajukan</h5>
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?php echo e(route('submitForm')); ?>" method="POST">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input name="idalokasi" type="text" class="form-control" value="<?php echo e($data->idalokasi); ?>" id="idalokasi" disabled>
                                                                    <input type="hidden" name="idalokasi" value="<?php echo e($data->idalokasi); ?>">
                                                                </div>
                                                                ...
                                                                <button type="submit" class="btn btn-primary">Submit</button>
                                                                 ...
                                                                 <!-- End Modal Form-->
                                                                <td><?php echo e($data->idalokasi); ?></td>
                                                                <td><?php echo e($data->keterangan); ?></td>
                                                                <td class="text-center"><?php echo e($data->ukuran); ?></td> 
                                                                <td class="text-center"><?php echo e($data->alokasiajukan); ?></td>
                                                                <td><?php echo e($data->zonapit); ?></td>
                                                                <td><?php echo e($data->wpp); ?></td>
                                                                <td><?php echo e($data->koefisien); ?></td>
                                                                <td><?php echo e($data->pangkalan); ?></td>
                                                                <td><?php echo e($data->kuota); ?></td>                                   
                                                                <td><?php echo e($data->namakapal); ?></td>
                                                            </tr>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                                                        </tbody>
                                                    </table>                                                   
                                    ...
                                    <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            ...
                                            <table class="table table-bordered mt-4">
                                                ...
                                                <tbody>
                                                    <?php $__currentLoopData = $sp_mig_realisasi_kapal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td><?php echo e($loop->iteration); ?></td>
                                                        <td><?php echo e($data->nama_pemilik); ?></td>
                                                        <td><?php echo e($data->nomor_izin_usaha); ?></td>
                                                        <td><?php echo e($data->nama_kapal); ?></td>
                                                        <td><?php echo e($data->nomor_izin); ?></td>
                                                        <td><?php echo e($data->tanggal_terbit); ?></td>
                                                        <td><?php echo e($data->keterangan); ?></td>
                                                        <td><?php echo e($data->berat_kotor); ?></td>
                                                    </tr>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </tbody>
                                            </table>
            ...
            <a href="<?php echo e(route ('siup_migrasi_pdf')); ?>"class="btn btn-primary">Cetak Resume</a>
    <br>
        </div>
    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kkp\resources\views/modules/siup/migrasi_pit/add.blade.php ENDPATH**/ ?>