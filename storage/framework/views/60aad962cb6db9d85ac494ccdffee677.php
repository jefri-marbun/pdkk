<div class="page-content container">
    <div class="page-header text-blue-d2">
        <center>
            <img src="<?php echo e(asset('public/images/garuda.png')); ?>" alt="Garuda" width="75" height="75">
    ...
    <div class="col-sm-6">
        ...
        <table>
            ...
            <tr>
                <td>Nomor SIUP</td>
                <td>:</td>
                <td><?php echo e($data->nomor_siup); ?></td>
            </tr>
            <tr>
                <td>Tanggal SIUP</td>
                <td>:</td>
                <td><?php echo e($data->tanggal_siup); ?></td>
            </tr>
            <tr>
            ...
            <tr>
                <td>NIB</td>
                <td>:</td>
                <td><?php echo e($data->nib); ?></td>
            </tr>
            <tr>
                <td>NPWP</td>
                <td>:</td>
                <td><?php echo e($data->npwp); ?></td>
            </tr>
            <tr>
                <td>Ruang Lingkup Kegiatan</td>
                <td>:</td>
                <td><?php echo e($data->ruang_lingkup); ?></td>
            </tr>
            <tr>
                <td>Jumlah Kapal Penangkap Ikan</td>
                <td>:</td>
                <td><?php echo e($data->jumlah_kapal_penangkap); ?></td>
            </tr>
            <tr>
                <td>Total Kuota</td>
                <td>:</td>
                <td><?php echo e($data->total_kuota); ?></td>
            </tr>
            <tr>
                <td>Masa Berlaku</td>
                <td>:</td>
...
<?php /**PATH C:\laragon\www\kkp\resources\views/modules/siup/migrasi_pit/pdfsertifikat.blade.php ENDPATH**/ ?>