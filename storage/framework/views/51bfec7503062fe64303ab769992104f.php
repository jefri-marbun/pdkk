...
<html lang="en">
    ...
    <body class="body-bg-f8faff">
        ...
        <div class="all-section-area">
                            ...
                            <div class="header-right-content d-flex align-items-center">
                                <div class="header-right-option notification-option messenger-option dropdown">
                                    <div class="dropdown-item dropdown-toggle" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <div class="messages-btn">
                                            <img src="<?php echo e(URL::asset('resources/assets/images/icon/message.svg')); ?>" alt="message">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <div class="dropdown-wrap" data-simplebar>
                                            <a href="chat.html" class="dropdown-item d-flex">
                                                <div class="icon">
                                                    <img src="<?php echo e(URL::asset('resources/assets/images/user/user-1.png')); ?>" alt="user-1">
                                                </div>
                                            ...
                                            <a href="chat.html" class="dropdown-item d-flex">
                                                <div class="icon">
                                                    <img src="<?php echo e(URL::asset('resources/assets/images/user/user-2.png')); ?>" alt="user-2">
                                                </div>
                                            ...
                                            <a href="chat.html" class="dropdown-item d-flex">
                                                <div class="icon">
                                                    <img src="<?php echo e(URL::asset('resources/assets/images/user/user-3.png')); ?>" alt="user-3">
                                                </div>
                                            ...
                                            <a href="chat.html" class="dropdown-item d-flex">
                                                <div class="icon">
                                                    <img src="<?php echo e(URL::asset('resources/assets/images/user/user-4.png')); ?>" alt="user-4">
                                                </div>
                                            ...
                                            <a href="chat.html" class="dropdown-item d-flex">
                                                <div class="icon">
                                                    <img src="<?php echo e(URL::asset('resources/assets/images/user/user-5.png')); ?>" alt="user-5">
                                                </div>
                                ...
                                <div class="header-right-option notification-option dropdown">
                                    <div class="dropdown-item dropdown-toggle" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <div class="notification-btn">
                                            <img src="<?php echo e(URL::asset('resources/assets/images/icon/notification.svg')); ?>" alt="notification">
                                ...
                                <div class="header-right-option dropdown profile-nav-item pt-0 pb-0">
                                    <a class="dropdown-item dropdown-toggle avatar d-flex align-items-center" href="#" id="navbarDropdown-4" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        <img src="<?php echo e(URL::asset('resources/assets/images/avatar.png')); ?>" alt="avatar">
                                    ...
                                    <div class="dropdown-menu">
                                        <div class="dropdown-header d-flex flex-column align-items-center">
                                            <div class="figure mb-3">
                                                <img src="<?php echo e(URL::asset('resources/assets/images/avatar.png')); ?>" class="rounded-circle" alt="avatar">
                                            </div>
        
                                            <div class="info text-center">
                                                <span class="name">Joven</span>
                                                <p class="mb-3 email">
                                                    <a href="mailto:<?php echo e(session('email')); ?>"><?php echo e(session('email')); ?></a>
                                                </p>
                                            </div>
                                        ...
                                        <div class="dropdown-footer">
                                            <ul class="profile-nav">
                                                <li class="nav-item">
                                                    <a href="<?php echo e(URL::route('logout')); ?>" class="nav-link">
            ...
            <nav class="sidebar-menu">
                <ul class="list-group flex-column d-inline-block first-menu" data-simplebar>
                    ...
                    <li class="list-group-item main-grid <?php echo Route::currentRouteName() == 'siup_migrasi_pit' || Route::currentRouteName() == 'siup_migrasi_pit_operation' ? 'active' : ''; ?>">
                        <a href="#" class="icon">
                            <img src="<?php echo e(URL::asset('resources/assets/images/icon/document-copy.svg')); ?>" alt="document-copy">
                        </a>
                        <ul class="list-group flex-column d-inline-block submenu" data-simplebar>
                            <li class="list-group-item <?php echo Route::currentRouteName() == 'siup_migrasi_pit' || Route::currentRouteName() == 'siup_migrasi_pit_operation' ? 'active' : ''; ?>">
                                <a href="<?php echo URL::route('siup_migrasi_pit'); ?>">SIUP Migrasi PIT</a>
                            </li>
                ...
                <div class="footer-area">
                    <div class="container-fluid">
                        <div class="footer-content">
                            <p>&copy; <?php echo date('Y'); ?> SILAT <sup>NG</sup> (SISTEM INFORMASI IZIN LAYANAN CEPAT)</p>
                        </div>
                    </div>
                </div>
                <!-- End Footer Area -->
        ...
        <script src="<?php echo e(URL::asset('resources/assets/js/calendar.js')); ?>"></script>
...
</html><?php /**PATH C:\laragon\www\kkp\resources\views/index.blade.php ENDPATH**/ ?>