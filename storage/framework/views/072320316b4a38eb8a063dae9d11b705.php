    ...
    <div class="faq-area">
        <div class="container-fluid">
            <div class="contact-form">
                ...
                <!-- START AUTHOR BY JO -->
                <form id="contactForm" method="GET" action="<?php echo e(URL::to('siup/migrasi-pit/add')); ?>" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-lg-12">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kkp\resources\views/modules/siup/migrasi_pit/index.blade.php ENDPATH**/ ?>