                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-3 col-sm-6">
                                    <div class="single-audience d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="icon">
                                            <img src="{{ URL::asset('resources/assets/images/icon/white-profile-2user.svg') }}" alt="white-profile-2user">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    <div class="single-audience d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="icon">
                                            <img src="{{ URL::asset('resources/assets/images/icon/eye.svg') }}" alt="eye">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    <div class="single-audience d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="icon">
                                            <img src="{{ URL::asset('resources/assets/images/icon/timer.svg') }}" alt="timer">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    <div class="single-audience d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="icon">
                                            <img src="{{ URL::asset('resources/assets/images/icon/mask.svg') }}" alt="mask">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <table class="table align-middle">
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row">
                                        <a href="index.html">
                                            <img src="{{ URL::asset('resources/assets/images/icon/link.svg') }}" alt="link">
                                        </a>
                                    </th>
                                    <td>
                                        <span>Homepage</span>
                        ...
                        <table class="table align-middle">
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row">
                                        <a href="index.html">
                                            <img src="{{ URL::asset('resources/assets/images/apps/chrome.svg') }}" alt="chrome">
                                ...
                                <tr>
                                    <th scope="row">
                                        <a href="index.html">
                                            <img src="{{ URL::asset('resources/assets/images/apps/mozilla.svg') }}" alt="mozilla">
                                ...
                                <tr>
                                    <th scope="row">
                                        <a href="index.html">
                                            <img src="{{ URL::asset('resources/assets/images/apps/safari.svg') }}" alt="safari">
                                ...
                                <tr>
                                    <th scope="row">
                                        <a href="index.html">
                                            <img src="{{ URL::asset('resources/assets/images/apps/edge.svg') }}" alt="edge">
                                ...
                                <tr>
                                    <th scope="row">
                                        <a href="index.html">
                                            <img src="{{ URL::asset('resources/assets/images/apps/opera.svg') }}" alt="opera">
                                ...
                                <tr>
                                    <th scope="row">
                                        <a href="index.html">
                                            <img src="{{ URL::asset('resources/assets/images/apps/uc-browser.svg') }}" alt="uc-browser">
